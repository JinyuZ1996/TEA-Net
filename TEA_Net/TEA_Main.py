...
from TEA_Net.TEA_Config import *
from TEA_Net.TEA_Printer import *
from TEA_Net.TEA_Train import *
...
if __name__ == '__main__':
    ...
    laplace_main, laplace_A, laplace_B = get_laplace_list(output_ratings, dict_A, dict_B, dict_U)
    # print("Already load the adj_list.")
    # matrix_form_graph = sum(laplace_main)
    ...
    model = TEA_Net(n_items_A=n_items_A, n_items_B=n_items_B, n_users=n_users, graph_main=laplace_main, graph_A=laplace_A,
                    graph_B=laplace_B)
    print("Already initialize the TEA_Net.")
